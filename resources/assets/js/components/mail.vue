                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="colums">
                            <p :class="{ 'control': true }">
                              <input v-validate="'required|min:4|url'" :class="{'input': true, 'is-danger': errors.has('website') }" name="website" v-model="website" type="text" placeholder="Website" class="form-control">
...
export default {
  data(){
    return {
        ...
        website: '',
        letter: '',
        url: 'http://centralsite.pev/api/data'
      }
  },
